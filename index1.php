<?php get_header(); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-1">
                ...
                <p><img src="<?php bloginfo('template_url'); ?>/images/startseite2.jpg" class="img-responsive text-center" alt="Karateka der FH Frankfurt"></p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div class="thumbnail">
                    <img src="<?php bloginfo('template_url'); ?>/images/Dirk02_131x98.jpg"  class="img-thumbnail" alt="Dirk Klasen">
                    <div class="caption">
                        <h3>Dirk Klasen<br><small>4. Dan</small></h3>
                        <p>
                            <p>dipl. Karatelehrer
                        ...
                        <p><a href="#" class="btn btn-primary" role="button">E-Mail</a></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3">
                <div class="thumbnail">
                    <img src="<?php bloginfo('template_url'); ?>/images/Ralph1_130x98.jpg"  class="img-thumbnail" alt="Ralph Nuss">
                    <div class="caption">
                        <h3>Ralph Nuss<br><small>3. Dan</small></h3>
                        <p>
                            <p>B-Trainer
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="thumbnail">
                    <img src="<?php bloginfo('template_url'); ?>/images/Sarah00_131x98.jpg"  class="img-thumbnail" alt="Sarah Holze">
                    <div class="caption">
                        <h3>Sarah Holze<br><small>1. Dan</small></h3>
                        <p>
                            <p>C-Trainerin
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="thumbnail">
                    <img src="<?php bloginfo('template_url'); ?>/images/Jan01_130x98.jpg"  class="img-thumbnail" alt="Jan Krieger">
                    <div class="caption">
                        <h3>Jan Krieger<br><small>1. Kyu</small></h3>
                        <p>
                            <p>Fach-Übungsleiter
    ...
    <div class="container">
        <div class="col-sm-4">
            ...
            <p>Geb. 2</p>
            </p><img src="<?php bloginfo('template_url'); ?>/images/lageplan_643x809.jpg" class="img-responsive" alt="Anfahrt"></div>
        <div class="col-sm-4">
